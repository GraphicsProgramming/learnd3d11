...
@(private)
Initialize :: proc (app : ^HelloD3D11Application) -> (ok : b32) {
...
@(private)
Cleanup :: proc(app : ^HelloD3D11Application) {
...
@(private)
CreateSwapchainResources :: proc (app : ^HelloD3D11Application) -> b32 {
...
@(private)
DestroySwapchainResources :: proc (app : ^HelloD3D11Application) {
